...
if (!isset($_SESSION['isLoggedIn']) || !$_SESSION['isLoggedIn'] || !($_SESSION['userRole'] == 'employee' || $_SESSION['userRole'] == 'manager' || $_SESSION['userRole'] == 'director')) {
...
<body>
    ...
    <main class="dashboard-main">
        ...
        <form class="search-form" method="POST">
            <input autocomplete="off" type="text" name="searchTermReservations" placeholder="Zoek naar reserveringen..." value="<?php echo htmlspecialchars($searchTermReservations); ?>">
